...
//		int number = 12010090;
  ...
  private static boolean tryPushAndAddLevel(String str, Stack<String> textStack,
      int numberStackSize) {
    ...
    if (!str.isEmpty()) {
      if (numberStackSize >= 3) {
        ...
        int position =
            numberStackSize / 3 % levelMap.size(); // 3 pasang angka di posisi yg ke-berapa
