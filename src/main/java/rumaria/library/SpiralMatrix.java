...
/**
 * example of matrix spiral 1   2   3   4 12  13  14   5 11  16  15   6 10   9   8   7
 */
public class SpiralMatrix {
  ...
  /**
   * generate spiral matrix starting from val 1 implementation with formula
   *
  ...
  /**
   * generate spiral matrix starting from val 1 implementation with following the spiraling path of
   * the matrix
   *
   * @param n, dimension of the spiral matrix
   * @return spiral matrix
